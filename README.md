# Smallest CMake for SFML and ImGui

This repository is a minimal starter project for building an SFML + ImGui application with CMake.

It currently includes:

- SFML 3.0.1 fetched with CMake `FetchContent`
- ImGui and ImGui-SFML integration
- A single executable target wired to `src/main.cpp`
- A small example window to confirm everything builds and runs

## How to Use

1. Install [Git](https://git-scm.com/downloads) and [CMake](https://cmake.org/download/). Use your system's package manager if available.
2. Clone this repository and open it in your editor.
3. Open [CMakeLists.txt](CMakeLists.txt). The project is configured as `SmallestCMakeForSFMLAndImGui`. Rename it if you want a different app name.
4. If you want to change the window title or initial UI, edit [src/main.cpp](src/main.cpp).
...
This repository was customized from an upstream SFML/CMake starter. The license file keeps the original upstream attribution where required.
